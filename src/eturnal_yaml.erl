...
%%%
%%% Copyright (c) 2020-2026 Holger Weiss <holger@zedat.fu-berlin.de>.
%%% Copyright (c) 2020-2026 ProcessOne, SARL.
%%% All rights reserved.
%%%
...
validator() ->
    options(
      #{secret => list_or_single(non_empty(binary())),
        ...
        strict_expiry => bool(),
        hmac_hash_algorithm => enum([sha, sha224, sha256, sha384, sha512, sha3_224, sha3_256, sha3_384, sha3_512, md5]),
