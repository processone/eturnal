...
On **DEB-based** Linux/x64 distributions, run:
    ...
    $ curl -O https://eturnal.net/download/package/eturnal_1.4.2-1_amd64.deb
    $ sudo dpkg -i eturnal_1.4.2-1_amd64.deb

On **RPM-based** Linux/x64 distributions, run:

    $ curl -O https://eturnal.net/download/package/eturnal-1.4.2-1.x86_64.rpm
    $ sudo rpm -i eturnal-1.4.2-1.x86_64.rpm
...
> (`chmod +x rebar3`), first.
    ...
    $ curl https://eturnal.net/download/eturnal-1.4.2.tar.gz | tar -C /tmp -xzf -
    $ cd /tmp/eturnal-1.4.2
    $ ./rebar3 as prod tar

This generates the archive file `_build/prod/rel/eturnal/eturnal-1.4.2.tar.gz`.
...
2.  Extract the archive generated [above](#compilation):
        ...
        # cd /opt/eturnal
        # tar -xzf /tmp/eturnal-1.4.2/_build/prod/rel/eturnal/eturnal-1.4.2.tar.gz
...
[10]: https://github.com/processone/eturnal/blob/1.4.2/build.config
[11]: https://en.wikipedia.org/wiki/YAML
[12]: https://github.com/processone/eturnal/blob/1.4.2/config/eturnal.yml
[13]: https://www.freedesktop.org/software/systemd/man/systemctl.html
[14]: https://github.com/processone/eturnal/blob/1.4.2/scripts/eturnal.init
[15]: https://www.freedesktop.org/software/systemd/man/systemd-journald.service.html
[16]: https://eturnal.net/documentation/
[17]: https://github.com/processone/eturnal/blob/1.4.2/CHANGELOG.md
