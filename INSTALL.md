...
> version.
    ...
    $ curl https://eturnal.net/download/eturnal-1.6.0.tar.gz | tar -C /tmp -xzf -
    $ cd /tmp/eturnal-1.6.0
    $ ./rebar3 as prod tar

This generates the archive file `_build/prod/rel/eturnal/eturnal-1.6.0.tar.gz`.
...
2.  Extract the archive generated [above](#compilation):
        ...
        # cd /opt/eturnal
        # tar -xzf /tmp/eturnal-1.6.0/_build/prod/rel/eturnal/eturnal-1.6.0.tar.gz
...
[7]: https://github.com/processone/eturnal/blob/1.6.0/build.config
[8]: https://github.com/processone/eturnal/blob/1.6.0/README.md
